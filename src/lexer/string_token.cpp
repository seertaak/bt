...
namespace bt { namespace lexer {
    ...
    auto operator!=(const string_token_t& l, const string_token_t& r) -> bool { return !(l == r); }

    auto operator<(const string_token_t& l, const string_token_t& r) -> bool {
        return lexicographical_compare(begin(l.value), end(l.value), begin(r.value), end(r.value));
    }

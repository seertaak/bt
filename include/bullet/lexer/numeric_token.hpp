...
namespace bt { namespace lexer { namespace literal { namespace numeric {
    struct tag {};
    ...
    struct floating_point_t : tag {
        ...
        floating_point_t(long double value, int width) : value(value), width(width) {}
    ...
    auto operator!=(const floating_point_t& l, const floating_point_t& r) -> bool;
}}}}  // namespace bt::lexer::literal::numeric

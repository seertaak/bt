...
namespace immer { namespace detail { namespace arrays {
    ...
    struct with_capacity {
        ...
        with_capacity(node_t* p, size_t s, size_t c) : ptr{p}, size{s}, capacity{c} {}
        ...
        with_capacity(with_capacity&& other) : with_capacity{empty()} { swap(*this, other); }
        ...
        static with_capacity from_fill(size_t n, T v) { return {node_t::fill_n(n, v), n, n}; }

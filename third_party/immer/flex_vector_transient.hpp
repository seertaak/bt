...
public:
     ...
     * complexity is *effectively* @f$ O(1) @f$.
     */
    void push_back(value_type value) { impl_.push_back_mut(*this, std::move(value)); }
     ...
     * *effectively* @f$ O(1) @f$.
     */
    void set(size_type index, value_type value) { impl_.assoc_mut(*this, index, std::move(value)); }
    ...
    void append(flex_vector_transient&& r) { concat_mut_lr_l(impl_, *this, r.impl_, r); }
    ...
    void prepend(flex_vector_transient&& l) { concat_mut_lr_r(l.impl_, l, impl_, *this); }
    ...
    IMMER_NODISCARD persistent_type persistent() && { return persistent_type{std::move(impl_)}; }
